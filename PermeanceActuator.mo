...
model PermeanceActuator
  ...
  parameter Modelica.Magnetic.FluxTubes.Material.HardMagnetic.BaseData material
     = 
  ...
  Modelica.Magnetic.FluxTubes.Sources.ConstantMagneticPotentialDifference mmf_PM(
  ...
  Modelica.Magnetic.FluxTubes.Examples.Utilities.TranslatoryArmatureAndStopper armature(
    final L = 0, 
    final m = m_a, 
    final c = c, 
    final d = d, 
  ...
  Modelica.Magnetic.FluxTubes.Basic.Ground ground annotation (Placement(transformation(extent = {{30, 
    -38}, {50, -18}}, rotation = 0)));
  Modelica.Magnetic.FluxTubes.Basic.ElectroMagneticConverter coil(
    ...
    annotation (Placement(transformation(
      ...
      extent = {{-10, -10}, {10, 10}}, 
      rotation = 90)));
  Modelica.Magnetic.FluxTubes.Shapes.Force.HollowCylinderRadialFlux g_ma(
    final dlBydx = 1, 
    final l = t / 2 + x, 
    final r_i = r_core, 
    ...
    annotation (Placement(transformation(
      ...
      extent = {{-10, -10}, {10, 10}}, 
      rotation = 270)));
  Modelica.Magnetic.FluxTubes.Shapes.Force.HollowCylinderRadialFlux g_mb(
    final r_i = r_core, 
    final r_o = r_core + l_air + l_PM, 
    final dlBydx = -1, 
    final l = t / 2 - x, 
    ...
    annotation (Placement(transformation(
      ...
      extent = {{-10, -10}, {10, 10}}, 
      rotation = 270)));
  Modelica.Magnetic.FluxTubes.Shapes.Leakage.CoaxCylindersEndFaces g_mLeak1(
